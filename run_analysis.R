...
if(!getwd()=="C:/Users/enough/Desktop/Geting and Cleaning Data/"){
  dir.create("C:/Users/enough/Desktop/Geting and Cleaning Data/")
}

##Warning message:
##In dir.create("C:/Users/enough/Desktop/Geting and Cleaning Data/") :
##  'C:\Users\enough\Desktop\Geting and Cleaning Data' already exists
...
##Merges the training and the text sets to create one data set
...
##prsent the name of all the data
...
Master.td <- data.table(Master)
TidyData <- Master.td[, lapply(.SD, mean), by = 'participants,activities']
